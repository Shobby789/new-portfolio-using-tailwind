    ...
    <header className="w-full">
      ...
      >
        ...
        <div
          ...
          onClick={handleShowSidebar}
        >
          <div className="h-full w-[80%] lg:w-[40%] bg-black shadow-2xl float-end flex flex-col justify-center items-start gap-8 px-12">
            <button
              onClick={handleShowSidebar}
              className="absolute top-6 right-10 lg:right-24 bg-black text-white transition-all duration-300"
            >
